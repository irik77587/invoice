  ...
  <Document>
    <Page size="A4" style={css.page}>
      <View style={css.heading}>
        ...
        <Text style={css.subtitle}>Invoice Date: {props.date}&nbsp;</Text>
        <Text style={css.subtitle}>Invoice Currency: {props.currency}&nbsp;</Text>
      </View>
      ...
      <View key={"invoice-pdf" + idx} style={css.tbody}>
